...
class CondConv3D(_ConvNd):
    def __init__(self, in_channels, out_channels, kernel_size, num_experts, num_coordinates, stride=1,
                 padding=0, dilation=1, groups=1,
                 bias=True, padding_mode='zeros', dropout_rate=0.0):
        ...
        self._routing_fn = _routing(num_coordinates * 3, num_experts, dropout_rate)
    ...
    def forward(self, inputs, locs):
        ...
        for i in range(b):
            ...
            loc = locs[i].unsqueeze(0)
            routing_weights = self._routing_fn(loc)
